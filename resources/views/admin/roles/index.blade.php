            ...
            <div class="table-responsive">
              <table class="table table-flush" id="roles-search">
               ...
               <tr>
                     ...
                     <td>
                         <a href="{{ route('admin.roles.edit', $role->id) }}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit Role"><i class="material-icons-round">mode_edit</i></a>
                         <a href="{{ route('admin.roles.show', $role->id) }}" data-bs-toggle="tooltip" data-bs-original-title="Preview Role Detail">
